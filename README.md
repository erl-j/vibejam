...
This repository is a bring-your-own-coding-agent browser-based system for music composition. 
To use as intended, clone this repo, load it into an LLM-augmented code editor (I like cursor & claude opus 4.5), and start jamming.
